...
public class LevarDano : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if ((namedequem == "Light" && (other.GetComponentInParent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("Low Punch")) && !(animator.GetCurrentAnimatorStateInfo(0).IsName("Parry"))) && !(animator.GetCurrentAnimatorStateInfo(0).IsName("Hit")))
        {
        ...
        else if ((namedequem == "Heavy" && (other.GetComponentInParent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("High Kick"))) && !(animator.GetCurrentAnimatorStateInfo(0).IsName("Hit")))
        {
        ...
        else if((other.GetComponentInParent<Animator>().GetCurrentAnimatorStateInfo(0).IsName("Low Punch") && animator.GetCurrentAnimatorStateInfo(0).IsName("Parry"))){
